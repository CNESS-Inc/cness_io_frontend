        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative p-2 w-full">
            <img
              ...
              onError={() => {
                return (
                  <div className="rounded-xl w-full h-54 bg-linear-to-br from-[#7077FE] to-[#9747FF] flex items-center justify-center">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-[#242E3A]">
                        {track.title}
                      </h4>
                      {track.description && (
                  ...
                  {track.file_urls && track.file_urls.length > 0 && (
                    <div className="text-sm text-gray-500">
                      {track.file_urls.length} file
                      {track.file_urls.length > 1 ? "s" : ""}
                    </div>
                  )}
                </div>
