  ...
  return (
    <section className="px-4 sm:px-8 py-8 sm:py-[59px]">
      <div className="text-center mb-18">
        <p className="poppins text-[#6F74DD] font-bold text-lg leading-[100%] tracking-[0.175em] text-center uppercase mb-6">
          Testimonials
        </p>
        <p className="poppins font-bold text-[52px] leading-[100%] tracking-normal text-center capitalize text-[#1E1E1E]">
          Our Client Reviews
        </p>
      </div>
          ...
          <div className=" h-[506px] bg-[url('/testimonial_1.png')] rounded-[18.12px] bg-cover bg-center relative overflow-hidden">
            ...
            <div className="absolute m-4.5 bottom-20 left-0 right-0 p-[42px] bg-white to-transparent rounded-[18.12px]">
              <div className="mb-[21px]">
                <p className="poppins text-[#1E1E1E] font-semibold text-lg leading-[100%] tracking-normal text-center capitalize">
                  Anika Sharma
                </p>
