...
const navItems: NavItem[] = [
  ...
  { label: "Dashborad", path: "/dashboard/new-marketplace/categories" },
  { label: "My Products", path: "/dashboard/new-marketplace/sellers" },
  { label: "Orderlist", path: "/dashboard/new-marketplace/ordershistory" },
  { label: "Seller Settings", path: "/dashboard/new-marketplace/library" },
  { label: "Payment Settings", path: "/dashboard/new-marketplace/wishlist" },
];
...
>
    ...
    <div className="flex items-center gap-2 sm:gap-3 shrink-0">
      ...
      >
        ...
        />
        <span className="hidden sm:inline">Buy a Product</span>
      </button>
