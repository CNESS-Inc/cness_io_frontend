...
export default function Highlight() {
 ...
 const [open, setOpen] = useState(false);
  ...
  return (
    <section className="highlight-section lg:min-h-[560px] px-4 sm:px-6 lg:px-8 py-18 sm:py-12 lg:py-[80px] bg-[#FAFAFA] relative lg:bg-[url(https://cdn.cness.io/ellipse.svg)] bg-no-repeat lg:bg-[position:right_bottom_3rem] overflow-hidden">
