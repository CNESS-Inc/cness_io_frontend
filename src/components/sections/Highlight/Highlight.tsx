...
export default function Highlight() {
 ...
 const [open, setOpen] = useState(false);
  ...
  ">
            ...
            <Button className="jakarta w-fit rounded-[100px] h-[42px] py-1 px-6 bg-linear-to-r from-[#7077FE] to-[#F07EFF] self-stretch transition-colors duration-500 ease-in-out lg:mx-0 md:mx-0 mx-auto"
