...
export default function SocialMedia() {
  ...
  return (
    <section className="bg-white px-4 sm:px-6 lg:px-8 pt-5 md:pt-10 pb-12 lg:py-[72px]">
      <div className="max-w-[1336px] mx-auto">
        <div className="flex flex-col md:flex-row lg:flex-row items-start lg:items-center gap-5 md:gap-8 lg:gap-16">
