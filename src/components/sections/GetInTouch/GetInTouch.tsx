  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://cdn.cness.io/Ellipse%203373%20(1).webp')",
        }}
      />
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-start gap-8 md:gap-12 xl:gap-16">
        ...
        <div className="w-full max-w-[640px] mx-auto bg-white shadow-lg rounded-[28px] p-5 sm:p-6 md:p-8">
          ...
          <div className="w-full h-[620px] md:h-[680px] lg:h-[712px] overflow-hidden">
            <LazyZohoForm
              url="https://forms.zohopublic.com/vijicn1/form/GetInTouch/formperma/x_WVVrlIZduQfJsgakmb-blY_rSPpNEQCpUVPe5E7nk"
        ...
        <div
          className="place-self-center flex flex-col items-center 
             text-center gap-3 md:gap-3 px-4"
        >
          <h3
          ...
          <p
            ...
            className="text-[16px] font-[300]  md:text-[16px] leading-[24px] md:leading-[24px] tracking-[-0.02em] text-[#64748B] text-center"
          >
