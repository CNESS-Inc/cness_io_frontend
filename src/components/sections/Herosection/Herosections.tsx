    ...
    <section className="relative h-[692px] rounded-[12px] overflow-hidden lg:mx-[12px]">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="text-center px-4">
          {/* Heading */}
          <h1 className="poppins text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
            Build with Consciousness
          </h1>

          {/* Description */}
          <p className="openSans text-lg sm:text-xl text-gray-200 mb-10 max-w-2xl mx-auto">
