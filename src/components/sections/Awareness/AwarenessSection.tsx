...
export default function AwarenessSection() {
  ...
  return (
    <>
            ...
            <div className="py-24 px-0 flex lg:flex-row flex-col items-center justify-between min-h-[720px] max-w-[1000px] w-full mx-auto">
              <div className="lg:w-6/12">
                <h3
                  ...
                  className=" leading-9 text-[32px] text-black font-500"
                >
                  Where conscious creations
                </h3>
                <p style={{ fontFamily: "Open Sans, sans-serif" }} className="text-[#898989] font-regular text-[14px] mt-4">
                  Explore a wide range of conscious products
                  <br /> crafted by verified creators who prioritize
                  <br /> sustainability and ethical practices.
                </p>
              </div>
              <div className="flex lg:w-6/12 flex-col lg:items-center items-start justify-start relative ">
                <AnimatePresence mode="wait">
                  <LottieOnView
                    ...
                    src="https://cnessioassets.project-69e.workers.dev/Rectangle-blink.json"
                    loop
      ...
      <AnimatePresence>
        ...
        "
                  >
                    Explore a wide range of conscious products crafted by
                    verified creators who
                    <br />
  ...
  "
        ...
        <div className="community-bottom m-0 bg-[url(https://res.cloudinary.com/diudvzdkb/image/upload/v1753780353/community-bg_cqdnuq.png)] w-full lg:px-8 md:px-8 px-4 py-16 flex justify-center items-center flex-col bg-cover bg-center">
          ...
          <p style={{ fontFamily: "Open Sans, sans-serif" }} className="mt-2 lg:text-[18px] md:text-[16px] text-[14px] font-[400] text-[#494949] text-center">
