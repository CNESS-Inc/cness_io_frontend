...
const Community: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="community-bottom bg-[url(/community-bg.png)] w-full px-8 py-12 flex justify-center items-center flex-col bg-cover bg-center">
        <h3 className="poppins text-[32px] font-[600] bg-gradient-to-b from-[#4E4E4E] to-[#232323] 
               text-transparent bg-clip-text mb-3 text-center">
          Connect with the trustworthy. Work with the <br/>reliable. Grow with the Dependable.
        </h3>
        <p className="openSans mt-2 text-[18px] font-[400] text-[#494949]">
