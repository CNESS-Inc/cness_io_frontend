...
const backgroundCards = [
  {
    id: 1,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779752/community-1_lfhqfv.png",
    alt: "Community Feature 1",
  },
  {
    id: 2,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779752/community-2_eshhqq.png",
    alt: "Community Feature 2",
  },
  {
    id: 3,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779752/community-3_zyj6ua.png",
    alt: "Community Feature 3",
  },
  {
    id: 4,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779752/community-4_fg6svu.png",
    alt: "Community Feature 4",
  },
  {
    id: 5,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779753/community-5_xbtjdi.png",
    alt: "Community Feature 5",
  },
  {
    id: 6,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779753/community-6_eezcrn.png",
    alt: "Community Feature 6",
  },
  {
    id: 7,
    type: "image",
    src: "https://res.cloudinary.com/diudvzdkb/image/upload/v1753779753/community-7_ezfjjb.png",
  ...
  return (
    ...
    >
      <div className="community-header">
        <h2
          className="poppins lg:leading-16 md:leading-14 leading-9 text-[32px] font-[600] bg-gradient-to-b from-[#4E4E4E] to-[#232323] 
        ...
        <p
          ...
          className="text-[#64748B] text-[18px] text-center w-fit mx-auto"
        >
      ...
      <div className="animation-container relative w-full h-[600px] lg:h-[700px]">
        ...
        <div className="background-cards">
          {backgroundCards.map((card, index) => (
            <div
              key={card.id}
              className={`background-card bg-card-${index + 1} ${
                cardsVisible ? "visible" : "fade-out"
              }`}
            >
        ...
        <div
          className={`main-image-container absolute inset-0 flex items-center justify-center z-10 ${getImageStepClass(
            currentStep
          )}`}
        >
          <Image
      ...
      <div className="community-bottom m-0 bg-[url(https://res.cloudinary.com/diudvzdkb/image/upload/v1753780353/community-bg_cqdnuq.png)] w-full lg:px-8 md:px-8 px-4 py-12 flex justify-center items-center flex-col bg-cover bg-center">
        <h3
          className="poppins lg:text-[32px] md:text-[32px] text-[23px] font-[600] bg-gradient-to-b from-[#4E4E4E] to-[#232323] 
