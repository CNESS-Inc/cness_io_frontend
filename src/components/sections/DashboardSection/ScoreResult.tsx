  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
       <div className="text-lg font-bold" style={{ color: scoreColor }}>{value}</div>
...
<div className="p-6 bg-[#f9f9f9] min-h-screen font-[Poppins]">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button className="bg-white border border-gray-200 text-[#64748B] text-sm font-medium px-5 py-2 rounded-full shadow-md">Share</button>
           <button className="bg-[#FF6B81] text-white text-sm font-medium px-5 py-2 rounded-full shadow-md">Report</button>
        </div>
      </div>
...
{/* Summary Cards */}
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] gap-4 mb-6">
          <div className="min-h-[208px] p-4 rounded-[12px] border border-[#eceef2] shadow-sm col-span-2" style={{ background: 'linear-gradient(135deg, #f5f2fc 0%, #fef3f8 100%)' }}>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-6 h-6 bg-[#e3d1f6] rounded-full flex items-center justify-center">
                <img src="./cis score.png" alt="Lightning Icon" className="w-8 h-6" />
              </div>
  ...
  {/* Top row with icon, title and dots */}
  <div className="flex items-center justify-between mb-2">
    ...
    <div className="text-xl text-[#999] leading-none cursor-pointer">⋯</div>
  </div>
  ...
  <div className="flex justify-center items-center h-full">
    <img src="/Inspired _ Badge.png" alt="CNESS Inspired" className="h-[87px] object-contain" />
  </div>
</div>
          ...
          <div className="h-[208px] bg-white rounded-[12px] p-3 shadow-sm border border-[#eceef2]">
            ...
            <div className="flex justify-center items-center">
              <span className="px-18 py-4 bg-[#eaf9f5] text-[#00bfa5] text-sm font-semibold rounded-[12px] inline-block">Inspired</span>
            </div>
          </div>
        </div>
...
<div className="w-[365px] h-[151px] bg-white rounded-[12px] border border-[#eceef2] p-[12px] flex flex-col justify-between shadow-sm">
  ...
  <div className="flex items-center justify-between">
    <div className="flex items-center gap-2">
      <img src="./Frame-qa.png" alt="Quantitative Icon" className="w-6 h-6" />
      <span className="text-sm font-semibold text-[#222224]">Quantitative Score</span>
    </div>
  </div>
 ...
 <div className="w-[365px] h-[151px] bg-white rounded-[12px] border border-[#eceef2] p-[12px] flex flex-col justify-between shadow-sm">
  ...
  <div className="flex items-center justify-between">
    <div className="flex items-center gap-2">
      <img src="./Frame-qu.png" alt="Quantitative Icon" className="w-6 h-6" />
      <span className="text-sm font-semibold text-[#222224]">Quantitative Score</span>
    </div>
  </div>
...
<div className="w-[365px] h-[151px] bg-white rounded-[12px] border border-[#eceef2] p-[12px] flex flex-col justify-between shadow-sm">
  ...
  <div className="flex items-center justify-between">
    <div className="flex items-center gap-2">
      <img src="./Frame-im.png" alt="Quantitative Icon" className="w-6 h-6" />
      <span className="text-sm font-semibold text-[#222224]">Improvement Score</span>
    </div>
  </div>
...
<div className="flex items-center gap-2 mt-6 mb-2">
    ...
    <img src="./Frame-scr.png" alt="Score Breakdown Icon" className="w-8 h-8" />

  <span className="text-sm font-semibold text-[#222224]">Score Breakdown</span>
</div>
{/* Horizontal divider */}
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 place-items-center">
    {scoreData.map((item, idx) => (
      ...
      >
        ...
        <div>
          <p className={`text-sm font-semibold ${item.tipColor} leading-none mb-0`}>
            {item.tip}
          </p>
