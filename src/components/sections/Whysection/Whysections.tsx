      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto">
        ...
        <div className="p-4 sm:p-5 md:p-6 col-span-1 md:col-span-7 order-2">
          <div className="max-w-2xl mx-auto">
            <h2 className="poppins text-base sm:text-lg md:text-xl lg:text-2xl font-bold uppercase tracking-normal leading-none text-[#7077FE] mb-3 sm:mb-4 md:mb-6">
              WHY CNESS
            </h2>

            <p className="poppins font-medium text-xl sm:text-2xl md:text-3xl lg:text-[42px] leading-snug sm:leading-normal md:leading-[1.3] lg:leading-[59px] text-black mb-4 sm:mb-5 md:mb-6">
            ...
            <ul className="list-disc pl-5 space-y-2 sm:space-y-3 md:space-y-4 mb-4 sm:mb-5 md:mb-6">
              <li className="openSans bg-white p-3 sm:p-4 md:p-[10px] rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base">
            ...
            <Button
              className="bg-[#7077FE] py-2 sm:py-3 md:py-[16px] px-3 sm:px-4 md:px-[24px] rounded-full text-xs sm:text-sm md:text-base"
              variant="primary"
              withGradientOverlay
            >
              Why Now
