...
const rows: Cell[] = [
  {
    left: "Open-source repositories",
    starter: "No limits",
    premium: "No restrictions",
  },
  {
    left: "Open repositories",
    starter: "Boundless",
    premium: "Infinite usage",
  },
  {
    left: "Accessible repositories",
    starter: "Unrestricted",
    premium: "Unlimited access",
  },
  {
    left: "Available repositories",
    starter: "No boundaries",
    premium: "Endless possibilities",
  },
  {
    left: "Publicly accessible repositories",
    starter: "Unlimited potential",
    premium: "No limits on usage",
  },
  {
    left: "Openly available repositories",
    starter: "No limits on features",
    premium: "Unlimited functionality",
  },
  {
    left: "Open repositories for all",
    starter: "Unlimited capabilities",
    premium: "Infinite access",
  },
  {
    left: "Public repositories available",
    starter: "No restrictions on access",
    premium: "Unlimited privileges",
  },
  {
  ...
  {
    left: "Open repositories for everyone",
    starter: "Unlimited access options",
    premium: "No limits on features",
  },
];
  ...
  return (
    <section className="mx-auto mt-10 mb-16 rounded-[12px] border border-[#EDEFF3] bg-white p-6 sm:p-8 max-w-[1900px]">
      ...
      <div className="flex items-center gap-3 pb-5 border-b border-[#EEF0F4]">
        ...
        <h3 className="font-poppins text-[16px] sm:text-[18px] font-medium text-[#081021]">
      ...
      <div className="mt-8 space-y-4 md:hidden">
        ...
        {rows.map((r, i) => (
          <div
            key={i}
            className="rounded-xl border border-[#ECEEF2] p-4 bg-white"
          >
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-3">
              <div className="rounded-lg border border-[#ECEEF2] p-3">
                ...
                <div className="text-[14px] font-open-sans text-gray-700">
                  {r.starter ?? "-"}
                </div>
              </div>
      ...
      <div className="hidden md:block mt-23">
        <div className="flex items-start gap-8 justify-center">
          ...
          {/* Starter Column */}
          <div
            className={`relative rounded-xl border border-[#ECEEF2] bg-white px-5 pb-5 pt-6 ${COL_W}`}
          >
          ...
          {/* Premium Column */}
          <div
            className={`relative rounded-xl border border-[#ECEEF2] bg-[#FBFAFA] px-5 pb-5 pt-6 ${COL_W}`}
          >
            {/* FLOATING pill (outside the box) */}
            <div className="absolute -top-15 left-0 w-full px-1">
              <Pill>Premium</Pill>
