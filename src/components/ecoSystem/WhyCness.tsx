  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center pt-5">
        ...
        <p className="openSans lg:text-lg md:text-[16px] text-white font-light pt-4 max-w-4xl mx-auto transition-all duration-1000 ease-in-out">
          ...
          <div key={item.id} className="relative group w-full h-full">
            ...
            <div className="relative z-10 w-full h-full rounded-tr-[30px] rounded-bl-4xl overflow-hidden">
              ...
              >
                ...
                <p className="font-['Open Sans'] openSans pt-3 text-white text-sm font-light">
                  {item.desc}
                </p>
              </div>
            </div>
