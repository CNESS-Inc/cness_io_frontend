        ...
        <div className="pt-5 flex flex-wrap gap-4 justify-center">
          {benefits.map((item, idx) => (
            ...
            >
              ...
              <span className="font-normal text-base text-[#64748B] font-['Open Sans']" style={{ fontFamily: "Open Sans, sans-serif" }}>
                {item.label}
              </span>
            </div>
          ))}
          ...
          {features.map((item, idx) => (
            ...
            >
              ...
              <div>
                ...
                <p className="font-['Open Sans'] font-light text-sm lg:text-base text-[#64748B] mt-1" style={{ fontFamily: "Open Sans, sans-serif" }}> 
                  {item.desc}
                </p>
              </div>
            </div>
