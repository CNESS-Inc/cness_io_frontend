  ...
  return (
    ...
    >
      <img
        ...
        aria-hidden="true"
      />
      <div className="relative flex flex-col items-center text-center z-10 pt-[60px] sm:px-20 px-4">
        ...
        <div className="pt-5 flex flex-wrap gap-4 justify-center">
          {benefits.map((item, idx) => (
            <div
              key={idx}
              className="flex items-center gap-2 rounded-full border border-[#CBD5E1] bg-white px-5 py-2 transition whitespace-nowrap">
