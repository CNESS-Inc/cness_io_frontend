...
<p className="font-['Open_Sans'] lg:text-lg md:text-[16px] text-[12px] font-[300] text-[#64748B] lg:mb-10 md:mb-12 my-4 max-w-4xl mx-auto transition-all duration-1000 ease-in-out">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-16 z-10">
            {levels.map((level, i) => (
              ...
              >
                ...
                <p className="font-['Open_Sans'] text-[#64748B] text-sm xl:text-base font-light w-full xl:max-w-xl mx-auto">
                  {level.description}
                </p>
              </div>
            ))}
