...
const CreditsWallet: React.FC = () => {
  ...
  return (
    <>
      <section className="relative w-full h-[200px] sm:h-[250px] md:h-[338px] mx-auto rounded-xl overflow-hidden mt-2">
        <AnimatedBackground />
        <img
        ...
        />
        <div className="relative w-full h-[313px] flex flex-col justify-center px-1 md:px-10">
          {/* Content */}
          <div className="relative z-10 space-y-8">
            {/* Title Section */}
            <div>
              <h2
                className="font-poppins font-bold text-[35px] leading-10  mb-1 text-gradient-to-b from-[4E4E4E] to-[#232323];
"
              >
                Your Credit Points
              </h2>
              <p className="font-openSans font-semibold text-[16px] leading-5 text-[#616161]">
                Accumulate Credit Points for every meaningful interaction
              </p>
            </div>

            {/* Credits Summary Bar */}
            <div
              className="flex items-center justify-between w-full max-w-8xl rounded-[20px]"
              style={{
                background: "rgba(255, 255, 255, 0.3)", // #000000 at 30% opacity
              ...
              <div className="">
                <div className="flex items-center justify-center rounded-lg">
                  <img
                    ...
                    alt="wallet"
                  ></img>
                  <p className="text-[16px] font-medium font-poppins text-[#616161]">
                    Total Credits Earned
                  </p>
                </div>

                <div>
                  <h3 className="font-poppins font-bold text-[57px] leading-[65px] mt-1 flex items-baseline gap-2">
                    {karmaCredits}
                    <span className="text-[57px] leading-10 font-bold text-[#101010] ">
                      Pts
                    </span>
                  </h3>
                </div>
      ...
      <div className="min-h-screen  font-poppins p-1">
        <div className="max-w-8xl mx-auto bg-white shadow-lg rounded-2xl overflow-hidden mb-6">

          {/* Tabs */}
          <div className="bg-white rounded-[20px] shadow-sm px-10 pt-10 pb-2  relative z-10">
            {/* Tabs */}
          ...
          ${
                        ...
                        <table className="w-full border-collapse text-sm">
                          <thead>
                            <tr className="bg-white">
                              ...
                              <th className="text-left font-['Open_Sans'] font-semibold text-[#242424] text-[14px] px-6 py-6 leading-[20px]"></th>
                            </tr>
                          </thead>
                              ...
                              (transaction: any, index: any) => (
                                ...
                                >
                                  ...
                                  <td className="text-right px-6 py-6 font-['Open_Sans'] font-semibold text-[14px] leading-[20px] align-middle">
                                    <span>
                                      {
                                        transaction.user_credit_config
                                          .description
                                      }
                                    </span>
                                  </td>
            ...
            {/* Footer Note */}
            <p className="text-[#242424] font-semibold text-left text-[14px] font-['Open_Sans'] leading-[22px] max-w-4xl">
