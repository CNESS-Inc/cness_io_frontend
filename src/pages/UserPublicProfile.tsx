...
*/
  ...
  useEffect(() => {
    ...
    const profileImage =
      userDetails?.profile_picture || "https://cdn.cness.io/default-avatar.svg";
    const userName =
      `${userDetails?.first_name} ${userDetails?.last_name}` || "CNESS User";
    const userDescription =
      userDetails?.bio || `Check out ${userName}'s profile on CNESS`;
                          ...
                          {isFriendLoading ? (
                            <>
                              ...
                              userDetails?.friend_request_status === "ACCEPT"
                                ? "Disconnecting..."
                                : !userDetails?.if_friend &&
                                  userDetails?.friend_request_status ===
                                    "PENDING"
                                ? "Cancelling..."
                                : "Connecting..."}
                            </>
          ...
          shadow hover:bg-[#5A61E8] transition"
                  ...
                  <div className="flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p className="text-gray-500 mt-2 max-w-2xl">
                      Best Practices help you showcase your conscious
                      leadership, ethical innovation, and positive impact. Add
                      one to begin building your conscious portfolio.
                    </p>
              ...
              <Button
                ...
                onClick={async () => {
                  if (deleteConfirmation.practiceId) {
                    await handleDeleteBestPractice(
                      deleteConfirmation.practiceId
                    );
