...
import { GetSingleBestPractice } from "../Common/ServerAPI";
...
const SingleBP = () => {
  const [isSaved, setIs_saved] = useState();
  ...
  const [_localLikeCount, setLocalLikeCount] = useState("");
  ...
  const handleCommentSubmit = async (_bpid?: any) => {
    try {
      ...
      //   };
      //   const res = await dispatch(
      //     apiCall("POST", "/best-practice/comment", "BPcomment", formattedData)
      //   );
  ...
  const fetchSavedPost = async () => {
    try {
      ...
      //   };
      //   const res = await dispatch(
      //     apiCall("POST", "/best-practice/save", "BpSave", formattedData)
      //   );
  ...
  return (
    <>
      <div className="flex flex-col w-full gap-4 p-4 md:flex-row">
        <div className="w-full px-4 h-[calc(100vh-100px)]">
          <div>
            ...
            <div className="flex flex-col mt-5">
              <div className="w-full bg-[#F9F9F9] rounded-lg p-4 mb-5">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  >
                    {/* <img
                      src={singlepost.profile?.profile_picture}
                      alt={"Unknown User"}
                  ...
                  {media?.file_type === "video/mp4" ? (
                    ...
                    <div className="relative w-full max-h-[500px]">
                      ...
                      <LazyLoadImage
                        ...
                        // height="auto"
                      />
                      {/* <button className="absolute bottom-[-42px] left-1/2 transform -translate-x-1/2 px-3 py-1 rounded-lg bg-yellow-500 text-black font-medium hover:bg-yellow-600 focus:outline-none">
                        I Aspire to Follow
                      </button> */}
                      {/* <Button
                        type="submit"
                        variant="gradient-primary"
                        className="rounded-full py-3 px-8 transition-all absolute bottom-[-42px] left-1/2 transform -translate-x-1/2 "
                      >
                        I Aspire to Follow
                      </Button> */}
                    </div>
