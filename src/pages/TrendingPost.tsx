...
const posts: Post[] = [
  {
    avatar: "/images/avatars/anu.jpg",
    name: "Anu",
    time: "2 hours ago",
    following: true,
    media: { type: "image", src: "/images/sea.jpg", alt: "Sea" },
    likes: 421000,
    reflections: 45,
  },
  {
  ...
  return (
    <div className="w-full px-4 md:px-6 py-5">
      ...
      <div className="mb-3 flex items-center justify-between">
        ...
        <button
          onClick={() => nav(-1)}
          className="inline-flex items-center gap-2 rounded-full border bg-white border-gray-200 px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50 bg-color-white"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_380px] gap-6">
        ...
        <aside className="xl:sticky xl:top-4 self-start">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm min-h-[560px]">
            ...
            <ol className="space-y-3 text-sm">
              {trendingTopics.map((t, idx) => (
                <li key={t.label} className="flex items-center justify-between">
                  <span className="text-gray-700">{idx + 1}. {t.label}</span>
            ...
            {/* extra chips to fill height nicely */}
