        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 text-justify">
            ...
            <p className="openSans text-[20px] text-gray-700 leading-relaxed mb-4">
              Through each day of building our vision is our intent — CNESS
              recognizes, aspires, inspires, and showcases organizations and
              individuals whose intent and action are for the greater good.
            </p>
            <p className="openSans text-[20px] text-gray-700 leading-relaxed mb-4">
              As the <strong>Consciousness SuperApp</strong>,through the
              ecosystem of social media, directory, community, networking, brand
              enhancing, development hacks, best practice, guidance and AI.
            </p>
            <p className="openSans text-[20px] text-gray-700 leading-relaxed mb-4">
              CNESS recognizes itself as the world’s most valuable company that
              offers the ultimate experience of transformation, interactions,
              trust and reliability, opportunities and growth. Our goal-{" "}
              <strong>Empower conscious individuals and organizations.</strong>
            </p>
            <p className="openSans text-[20px] text-gray-700 leading-relaxed">
              <strong>The "Good Guy"</strong> wins in being the reckoning brand,
              trusted as reliable and dependable, inspired & innovative,
              ethically run with greater goodness as intent and empowered in
              prosperity that serves humanity.
            </p>
          </div>
        </div>
      </section>
