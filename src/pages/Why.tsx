        ...
        <div className="relative z-10 max-w-5xl w-full flex flex-col items-center text-center space-y-10">
          ...
          >
            ...
            <p className="text-gray-800 mb-4">
              <strong>CNESS (Conscious Enterprise & Social Standards)</strong> was born from a
              simple but powerful question:
              <em className="text-purple-600 font-medium"> Can a business be both profitable and profoundly human?</em>
            </p>
            <p className="text-gray-800 mb-4">
              In today’s fast-paced world, enterprises are increasingly judged not only by what
              they produce—but by how they behave. Customers, employees, investors, and
              communities demand responsible, ethical, and sustainable practices.
            </p>
            <p className="text-gray-800 font-semibold">
              Yet, for most organisations, there has never been a clear, universal standard to
              measure these human values—
...
>
  ...
  <p>
    It needs more <span className="text-purple-700 font-bold">conscious businesses</span>.
  </p>
  <p className="mt-2">
