...
>
  ...
  <h2 className="font-['Poppins'] font-medium text-[42px] leading-[130%] tracking-[-0.02em] bg-gradient-to-b from-[#4E4E4E] to-[#232323] text-transparent bg-clip-text">
  <span className="block">Empowering Growth.</span>
  <span className="block mt-2">Connecting People. Creating Impact.</span>
</h2>
    <p className="mt-5 font-['Open Sans'] font-normal text-[16px] leading-[22px] text-[#64748B]">
     We’re building more than a platform—we’re shaping an ecosystem. From certifications and learning tools
      <br /> for professionals, to communities, marketplaces, and entertainment for individuals, our super app is
      <br />designed to help you grow, connect, and thrive with purpose.
    </p>
    <Button variant="gradient-primary" size="md"  onClick={scrollToGetInTouch}
  ...
  <div className="mx-auto max-w-[1200px] px-6">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-start">
      ...
      <div className="flex flex-col items-start gap-6">
        <p className="max-w-[620px] font-['Open Sans'] text-[15px] md:text-[16px] leading-[24px] text-[#64748B]">
          We Built Our Super App To Unite Learning, Certifications, Communities, And
          Marketplaces In One Ecosystem—Helping People And Businesses Grow, Connect,
    ...
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="rounded-[32px] border border-[#ECEEF2] bg-white/90 shadow-[0_6px_28px_rgba(16,24,40,0.06)] p-[24px] md:p-[30px] flex flex-col gap-[10px]">
        <h4 className="font-['Poppins'] font-medium text-[20px] md:text-[24px] leading-[1.2] text-[#111827]">Mission</h4>
      ...
      <div className="rounded-[32px] border border-[#ECEEF2] bg-white/90 shadow-[0_6px_28px_rgba(16,24,40,0.06)] p-[24px] md:p-[30px] flex flex-col gap-[10px]">
        <h4 className="font-['Poppins'] font-medium text-[20px] md:text-[24px] leading-[1.2] text-[#111827]">Vision</h4>
        <p className="font-['Open Sans'] text-[15px] md:text-[16px] leading-[24px] text-[#64748B]">
...
<section className="w-full bg-white py-12 md:py-16">
  <div className="max-w-[1800px] mx-auto bg-[#F5F7F9] rounded-[24px] md:rounded-[32px] px-6 sm:px-10 md:px-12 lg:px-[40px] py-8 sm:py-12 md:py-[50px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] items-center gap-8">
        ...
        <div className="text-center lg:text-left">
          <h2 className="font-poppins font-medium text-[32px] md:text-[42px] leading-[1.3] tracking-[-0.02em] text-[#000]">
            What Makes Us{" "}
            <span className="bg-gradient-to-r from-[#6340FF] to-[#D748EA] bg-clip-text text-transparent">Different</span>
          </h2>
          <p className="mt-4 font-['Open_Sans'] text-[15px] md:text-[16px] leading-relaxed text-[#64748B]">
            CNESS is a purpose-driven super app that unites certifications, learning, marketplace, communities, OTT, and social in one seamless ecosystem
          </p>

          <ul className="mt-8 space-y-5 text-left">
            {[
              { title: "First-Of-Its-Kind Consciousness Graph", desc: "Mapping verified values across people and companies." },
              { title: "Creator & Org Flywheel", desc: "Unlocks user-led growth and deep engagement." },
              { title: "Layered Platform", desc: "Integrates identity, learning, commerce, and content seamlessly." },
              { title: "High-Margin Monetization", desc: "Blends SaaS, subscriptions, and digital commerce." },
              { title: "Strong Cultural Relevance", desc: "Taps into the global demand for authenticity, wellbeing, and trust." },
            ].map((item, i) => (
              <li key={i} className="flex items-start gap-3">
                <CircleCheckBig className="mt-1 text-[#6340FF] w-5 h-5" />
                <div>
                  <h3 className="font-['Open_Sans'] font-semibold text-[16px] text-black">{item.title}</h3>
                  <p className="font-['Open_Sans'] text-[14px] leading-[20px] text-[#64748B] mt-1">{item.desc}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="relative flex items-center justify-center lg:justify-start">
          <img
            src="https://cdn.cness.io/whycness1.webp"
            alt="Seller"
...
<section
  ...
  style={{ background: "linear-gradient(180deg, #F8F6FF 0%, #FFFFFF 35%, #FFFFFF 65%, #F8F6FF 100%)" }}
>
  <div className="w-full px-6 md:px-10 lg:px-16 pt-10 lg:pt-20">
    <h2 className="font-['Poppins'] font-medium text-[32px] md:text-[42px] leading-[1.3] tracking-[-0.02em] text-[#111]">
      Our{" "}
      <span className="bg-gradient-to-r from-[#6340FF] to-[#D748EA] bg-clip-text text-transparent">Road ahead</span>
    </h2>
  </div>
...
<section
  className="w-full bg-white py-10 md:py-14 lg:py-16 lg:h-[868px] overflow-hidden"
>
  {/* Heading */}
  <div className="mx-auto max-w-[1100px] px-6 text-center">
    ...
    <p className="mt-3 font-['Open_Sans'] text-[14px] md:text-[15px] leading-[22px] text-[#738091]">
      CNESS is a super app that brings together tools for professional growth and<br />
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[50px]">
    {[
      { n: "001", title: "Social Media", desc: "Share stories, inspire others, and build your personal brand." },
      { n: "002", title: "Certification", desc: "Gain knowledge, upskill, and get certified with ease." },
      { n: "003", title: "Marketplace", desc: "A digital space to buy, sell, and showcase meaningful products." },
      { n: "004", title: "LMS", desc: "Access courses and structured learning paths to upskill at your pace." },
      { n: "005", title: "Directory", desc: "A hub to discover verified businesses, professionals, communities, and creators." },
      { n: "006", title: "Best Practices", desc: "Ensure ethical learning, responsible selling & conscious growth." },
      { n: "007", title: "AriOme", desc: "Explore curated content that informs, entertains, and inspires." },
      { n: "008", title: "Communities", desc: "Connect, collaborate, and grow with like-minded individuals." },
    ].map((item) => (
      <div
        key={item.n}
...
<img src={bulb} alt="icon" className="w-[12px] h-[12px]" />
          </span>
        </div>
...
>
  ...
  <div className="mx-auto max-w-[900px] px-4 sm:px-6 text-center">
    ...
    <p className="mt-3 font-['Open_Sans'] text-[14px] sm:text-[15px] md:text-[16px] leading-[22px] text-[#748399]">
      we’re a team of innovators, creators, and changemakers united by one
      belief:
