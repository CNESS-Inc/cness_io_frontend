  ...
  return (
    <section className="px-4 sm:px-6 py-6 md:py-[32px] bg-[#F7F7F7]">
      <div className="mb-8 md:mb-12 text-center">
        <h2
          className={`${jakarta.className} font-semibold text-3xl sm:text-4xl md:text-[52px] leading-[1.25] tracking-normal text-center text-gray-900 mb-4`}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 py-6 md:py-[32px] px-2">
        <div className="rounded-xl md:rounded-[12px] border border-[#F1EFEC] p-4 md:p-6 bg-white backdrop-blur-[100px]">
          ...
          <div>
            <p
              className={`${poppins.className} font-semibold text-xl md:text-[25px] leading-[120%] tracking-[0%] mt-4 md:mt-[27px] mb-3 md:mb-[18px]`}
            >
              Built on DoCM
            </p>
            <p
              className={`${openSans.className} font-normal text-base md:text-[20px] leading-[150%] tracking-[0%] text-[#666464]`}
            >
