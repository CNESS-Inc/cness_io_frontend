        ...
        <div className="max-w-7xl mx-auto lg:flex md:grid flex justify-between lg:grid-cols-2 grid-cols-2 md:grid-cols-5 lg:gap-6 md:gap-8 gap-2">
          ...
          <div className="lg:col-span-2 lg:w-[40%] md:col-span-2  space-y-4">
            ...
            <p
              ...
              className="text-[16px] font-[400] leading-[160%] text-[#1E1E1E] lg:block md:block hidden"
            >
            ...
            <div className="flex justify-between gap-6 md:gap-8">
              ...
              <div className="w-fit space-y-3 md:space-y-4">
                ...
                <ul className="space-y-1 md:space-y-2">
                  <li><a href="/sign-up" className="text-[13px] md:text-base hover:underline">Try CNESS</a></li>
                  <li><Link to="/comingsoon" className="text-[13px] md:text-base hover:underline">Marketplace</Link></li>
                  <li><Link to="/comingsoon" className="text-[13px] md:text-base hover:underline">Community</Link></li>
                  <li><a href="/about" className="text-[13px] md:text-base hover:underline">About</a></li>
                </ul>
              </div>*/}
                ...
                <ul className="space-y-1 md:space-y-2">
                  <li>
                    <Link
                      to="/ecosystem"
                      style={{ fontFamily: "Open Sans, sans-serif" }}
                      className="text-[16px] leading-[160%] font-[400] text-[#1E1E1E] hover:underline"
                      onClick={() =>
                ...
                <ul className="space-y-1 md:space-y-2">
                  <li>
                    <a
                      ...
                      style={{ fontFamily: "Open Sans, sans-serif" }}
                      className="flex items-center text-[16px] leading-[160%] font-[400] text-[#1E1E1E] hover:underline"
                    >
