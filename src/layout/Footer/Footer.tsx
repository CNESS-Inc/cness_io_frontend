    ...
    <>
      ...
      <footer className="bg-[#F7F7F7] text-black py-8 md:py-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto lg:flex md:grid flex justify-between lg:grid-cols-2 grid-cols-2 md:grid-cols-5 lg:gap-6 md:gap-8 gap-2">
          ...
          <div className="col-span-2 lg:w-[50%] w-[80%] sm:col-span-3 md:col-span-3 space-y-4">
            <div className="flex justify-between gap-6 md:gap-8">
              ...
              <div className="w-fit space-y-3 md:space-y-4 ">
                ...
                <ul className="space-y-1 md:space-y-2">
                  <li><Link to="/" className="lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>Home</Link></li>
                  <li><a href="/about" className="lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">About Us</a></li>
                  <li><a href="/directory" className="lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">Directory</a></li>
                  <li><a href="/sign-up" className="lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">Certifications</a></li>
                  <li><Link to="/comingsoon" className="lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">Career</Link></li>
                </ul>
              </div>
              ...
              <div className="w-fit sm:col-span-1 space-y-3 md:space-y-4">
                ...
                <ul className="space-y-1 md:space-y-2">
                  <li>
                    <a href="https://www.facebook.com/share/1A8V21L6Qj" className="flex items-center lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">
                      <FaFacebookF className="me-2 md:me-3" />
                      Facebook
                    </a>
                  </li>
                  <li>
                    <a href="https://x.com/CnessInc" className="flex items-center lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">
                      <FaTwitter className="me-2 md:me-3" />
                      X
                    </a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/cness.inc" className="flex items-center lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">
                      <FaInstagram className="me-2 md:me-3" />
                      Instagram
                    </a>
                  </li>
                  <li>
                    <a href="https://www.youtube.com/@CNESSinc" className="flex items-center lg:text-[16px] text-[13px] leading-[160%] font-[400] font-openSans text-[#1E1E1E] hover:underline">
      ...
      <div className="py-4 bg-[#C6C4FF] px-4 sm:px-6">
        <div className="max-w-7xl mx-auto lg:flex flex-col md:flex-row justify-between items-center gap-2 hidden">
          <div
            className="text-[14px] leading-[100%] font-[500] font-[Plus Jakarta Sans] text-black"
            style={{
              letterSpacing: "-0.2px",
              fontStyle: "normal",
            }}
          ...
          <div className="flex flex-wrap justify-between gap-4 md:gap-16 lg:gap-24">
            ...
            <Link to="/terms-and-conditions" className="text-[14px] leading-[100%] font-[500] font-[Plus Jakarta Sans] text-black">
              Terms & Conditions
            </Link>
            <Link to="/privacy-policy" className="text-[14px] leading-[100%] font-[500] font-[Plus Jakarta Sans] text-black">
              Privacy Policy
            </Link>
          </div>
        </div>
