...
circle_prompts_collection = db.circle_prompts  # Q&A Prompts
circle_prompt_answers_collection = db.circle_prompt_answers  # Answers to prompts
...
async def seed_circles():
    ...
    sample_circles = [
        ...
        },
        {
            ...
            "interest_name": "Mindfulness & Meditation",
            "creator_id": "system",
            "member_count": 8930,
            "active_today": 567,
            "online_now": 145,
